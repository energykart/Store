                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <img src="/Store/img/pizza-'.$itemId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
...
<?php 
    ...
    while($pizzaRow = mysqli_fetch_assoc($pizzaResult)){
        ...
        $itemCategorieId = $pizzaRow['itwmCategorieId'];
        $itemDesc = $pizzaRow['itemDesc'];
?>

<!-- Modal -->
<div class="modal fade" id="updateItem<?php echo $itemId; ?>" tabindex="-1" role="dialog" aria-labelledby="updateItem<?php echo $pizzaId; ?>" aria-hidden="true">
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
		   		<div class="form-group col-md-8">
					...
					<small id="Info" class="form-text text-muted mx-3">Please .jpg file upload.</small>
					<input type="hidden" id="pizzaId" name="pizzaId" value="<?php echo $itemId; ?>">
		...
		<form action="partials/_menuManage.php" method="post">
			...
			<div class="text-left my-2 row">
				...
				<div class="form-group col-md-6">
                	...
                	<input class="form-control" id="catId" name="catId" value="<?php echo $itemCategorieId; ?>" type="number" min="1" required>
				</div>
            </div>
            <div class="text-left my-2">
